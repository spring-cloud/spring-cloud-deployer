 ...
 * {@value #SCDE_EXTERNAL_SERVERS_REQUIRED}.
 *
 * @author Eric Bottard
 * @author Gary Russell
...
public abstract class AbstractExternalResourceTestSupport<R> implements TestRule {
	...
	public static final String SCDE_EXTERNAL_SERVERS_REQUIRED = "SCDE_EXTERNAL_SERVERS_REQUIRED";
	...
	private Statement failOrSkip(final Exception e) {
		String serversRequired = System.getenv(SCDE_EXTERNAL_SERVERS_REQUIRED);
