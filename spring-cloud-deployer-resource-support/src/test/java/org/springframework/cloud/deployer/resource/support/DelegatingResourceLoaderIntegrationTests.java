...
public class DelegatingResourceLoaderIntegrationTests {
	...
	public void test() throws Exception {
		...
		Resource resource = delegatingResourceLoader.getResource("https://repo.spring.io/release/org/springframework/cloud/stream/app/file-sink-rabbit/1.2.0.RELEASE/file-sink-rabbit-1.2.0.RELEASE.jar");
